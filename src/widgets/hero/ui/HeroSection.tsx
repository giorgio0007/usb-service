      ...
      <Container className="relative">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          <div className="animate-fade-in-up">
            ...
            <RatingBadges className="mt-8 justify-center sm:justify-start" />
          </div>
          ...
          <div className="relative mx-auto w-full max-w-md animate-fade-in-up animation-delay-200 lg:max-w-none">
            ...
            <div className="absolute -bottom-3 -left-3 rounded-2xl border border-white/10 bg-white/10 px-4 py-3 backdrop-blur-xl">
